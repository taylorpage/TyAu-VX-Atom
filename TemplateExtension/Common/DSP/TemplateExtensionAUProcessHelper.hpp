//
//  TemplateExtensionAUProcessHelper.hpp
//  TemplateExtension
//
...
#include <vector>
#include "TemplateExtensionDSPKernel.hpp"
#include "TemplateExtensionBufferedAudioBus.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(TemplateExtensionDSPKernel& kernel, BufferedInputBus& bufferedInputBus)
    : mKernel{kernel},
...
private:
    TemplateExtensionDSPKernel& mKernel;
